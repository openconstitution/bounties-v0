...
describe('Component Tests', () => {
  describe('Funding Management Delete Component', () => {
    let comp: FundingDeleteDialogComponent;
    let fixture: ComponentFixture<FundingDeleteDialogComponent>;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .compileComponents();
      fixture = TestBed.createComponent(FundingDeleteDialogComponent);
