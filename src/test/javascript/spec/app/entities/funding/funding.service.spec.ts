...
describe('Service Tests', () => {
  describe('Funding Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(FundingService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Funding(0, 0, 'AAAAAAA', false);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Funding', () => {
        ...
        service.create(new Funding()).subscribe(resp => (expectedResult = resp.body));
