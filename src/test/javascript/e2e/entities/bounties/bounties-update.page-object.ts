...
export default class BountiesUpdatePage {
  pageTitle: ElementFinder = element(by.id('bountiesApp.bounties.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  statusSelect: ElementFinder = element(by.css('select#bounties-status'));
  urlInput: ElementFinder = element(by.css('input#bounties-url'));
  amountInput: ElementFinder = element(by.css('input#bounties-amount'));
  experienceSelect: ElementFinder = element(by.css('select#bounties-experience'));
  commitmentInput: ElementFinder = element(by.css('input#bounties-commitment'));
  typeSelect: ElementFinder = element(by.css('select#bounties-type'));
  categorySelect: ElementFinder = element(by.css('select#bounties-category'));
  keywordsInput: ElementFinder = element(by.css('input#bounties-keywords'));
  permissionInput: ElementFinder = element(by.css('input#bounties-permission'));
  expiresInput: ElementFinder = element(by.css('input#bounties-expires'));
  issueSelect: ElementFinder = element(by.css('select#bounties-issue'));
