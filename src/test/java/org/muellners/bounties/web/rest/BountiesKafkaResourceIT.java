...
class BountiesKafkaResourceIT {
  ...
  void setup() {
    ...
    BountiesKafkaResource kafkaResource =
        new BountiesKafkaResource(kafkaProperties);
  ...
  void producesMessages() throws Exception {
    restMockMvc
        .perform(post(
            "/api/bounties-kafka/publish/topic-produce?message=value-produce"))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON));

    Map<String, Object> consumerProps =
        new HashMap<>(getConsumerProps("group-produce"));
  ...
  void consumesMessages() throws Exception {
    ...
    MvcResult mvcResult =
        restMockMvc
            .perform(get("/api/bounties-kafka/consume?topic=topic-consume"))
=======
import java.time.Duration;
import java.util.Collections;
import java.util.HashMap;
