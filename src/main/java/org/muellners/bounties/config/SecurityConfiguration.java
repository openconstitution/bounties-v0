...
import java.util.*;
import org.muellners.bounties.security.*;
import org.muellners.bounties.security.SecurityUtils;
import org.muellners.bounties.security.oauth2.AudienceValidator;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
  ...
  public void configure(HttpSecurity http) throws Exception {
    ...
    http.csrf()
        ...
        .hasAuthority(AuthoritiesConstants.ADMIN)
        .antMatchers("/api/bounties-kafka/publish")
        .permitAll()
        .and()
        .oauth2Login()
        .and()
    ...
    return (authorities) -> {
      ...
      authorities.forEach(authority -> {
        ...
        if (authority instanceof OidcUserAuthority) {
          ...
          mappedAuthorities.addAll(SecurityUtils.extractAuthorityFromClaims(
