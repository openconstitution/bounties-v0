...
public class OAuthIdpTokenResponseDTO implements Serializable {
  ...
  @JsonProperty("ext_expires_in") private Long extExpiresIn;

  @JsonProperty("expires_on") private Long expiresOn;

  @JsonProperty("not-before-policy") private Long notBefore;
  ...
  @JsonProperty("refresh_expires_in") private String refreshExpiresIn;
